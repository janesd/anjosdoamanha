...
class Jurisdicionado(db.Model):
    ...
    escolaridade = db.Column(db.Integer, db.ForeignKey('escolaridade.id'))
    turno = db.Column(db.Integer, db.ForeignKey('turno.id'))
    instituicao_educacional = db.Column(db.String(200))
    fone_instituicao = db.Column(db.String(30))
    desempenho_escolar = db.Column(db.Integer, db.ForeignKey('desempenho.id'))
